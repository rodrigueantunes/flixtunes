...
- **L'assemblage des paquets Linux, lui, demande une machine Linux**, et c'est dit avant de commencer plutôt qu'après cent mégaoctets téléchargés : le `.deb` passe par `fpm`, que Windows n'a pas, et l'AppImage pose un lien symbolique qu'il refuse de créer. Essayé, mesuré, et consigné.
